...
//
//	mockgen -source=urgency_repository.go -destination=urgency_repository_gomock.go -package=repositories mountain_service/urgency/internal/repositories -imports=gomock=go.uber.org/mock/gomock -typed
//
...
func (mr *MockUrgencyRepositoryMockRecorder) Create(ctx, urgency any) *gomock.Call {
...
func (mr *MockUrgencyRepositoryMockRecorder) Delete(ctx, urgencyID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUrgencyRepositoryMockRecorder) GetAll(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUrgencyRepositoryMockRecorder) GetByID(ctx, id, urgency any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// GetByIDPrimary mocks base method.
...
// GetByIDPrimary indicates an expected call of GetByIDPrimary.
func (mr *MockUrgencyRepositoryMockRecorder) GetByIDPrimary(ctx, id, urgency any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockUrgencyRepository) List(ctx context.Context, filters map[string]any) ([]model.Urgency, error) {
	m.ctrl.T.Helper()
...
func (mr *MockUrgencyRepositoryMockRecorder) List(ctx, filters any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockUrgencyRepository) ListPaginated(ctx context.Context, page, pageSize int, assignedEmployeeID *uint) ([]model.Urgency, int64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListPaginated", ctx, page, pageSize, assignedEmployeeID)
	ret0, _ := ret[0].([]model.Urgency)
	ret1, _ := ret[1].(int64)
	ret2, _ := ret[2].(error)
...
func (mr *MockUrgencyRepositoryMockRecorder) ListPaginated(ctx, page, pageSize, assignedEmployeeID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListPaginated", reflect.TypeOf((*MockUrgencyRepository)(nil).ListPaginated), ctx, page, pageSize, assignedEmployeeID)
}

// ListUnassignedIDs mocks base method.
func (m *MockUrgencyRepository) ListUnassignedIDs(ctx context.Context) ([]uint, error) {
	m.ctrl.T.Helper()
...
func (mr *MockUrgencyRepositoryMockRecorder) ListUnassignedIDs(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListUnassignedIDs", reflect.TypeOf((*MockUrgencyRepository)(nil).ListUnassignedIDs), ctx)
}
...
func (mr *MockUrgencyRepositoryMockRecorder) ResetAllData(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUrgencyRepositoryMockRecorder) Update(ctx, urgency any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
