...
func (mr *MockActivityRepositoryMockRecorder) Create(activity interface{}) *gomock.Call {
...
func (mr *MockActivityRepositoryMockRecorder) Delete(id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockActivityRepositoryMockRecorder) GetByID(id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockActivityRepositoryMockRecorder) List(filter interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
