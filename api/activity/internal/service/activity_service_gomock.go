...
//
//	mockgen -source=activity_service.go -destination=activity_service_gomock.go -package=service mountain_service/activity/internal/service -imports=gomock=go.uber.org/mock/gomock -typed
//
...
func (mr *MockActivityServiceMockRecorder) LogEmployeeActivity(activityType, level, title, description, employeeID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockActivityServiceMockRecorder) LogSystemActivity(activityType, level, title, description any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockActivityServiceMockRecorder) LogUrgencyActivity(activityType, level, title, description, urgencyID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
