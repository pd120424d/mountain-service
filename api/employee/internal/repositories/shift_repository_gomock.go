...
func (mr *MockShiftRepositoryMockRecorder) GetOnCallEmployees(currentTime, shiftBuffer interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockShiftRepositoryMockRecorder) GetShiftAvailabilityWithEmployeeStatus(employeeID, start, end interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockShiftRepositoryMockRecorder) RemoveEmployeeFromShiftByDetails(employeeID, shiftDate, shiftType interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
