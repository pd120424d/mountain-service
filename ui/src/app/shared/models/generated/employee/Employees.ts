...
import {
  GithubComPd120424DMountainServiceApiEmployeeInternalHandlerActiveEmergenciesResponse,
  GithubComPd120424DMountainServiceApiEmployeeInternalHandlerAssignShiftRequest,
  GithubComPd120424DMountainServiceApiEmployeeInternalHandlerAssignShiftResponse,
  GithubComPd120424DMountainServiceApiEmployeeInternalHandlerEmployeeResponse,
  GithubComPd120424DMountainServiceApiEmployeeInternalHandlerEmployeeUpdateRequest,
  ...
  GithubComPd120424DMountainServiceApiEmployeeInternalHandlerOnCallEmployeesResponse,
  GithubComPd120424DMountainServiceApiEmployeeInternalHandlerRemoveShiftRequest,
  GithubComPd120424DMountainServiceApiEmployeeInternalHandlerShiftResponse,
...
export class Employees<SecurityDataType = unknown> extends HttpClient<SecurityDataType> {
  ...
  employeesList = (params: RequestParams = {}) =>
    this.request<GithubComPd120424DMountainServiceApiEmployeeInternalHandlerEmployeeResponse[][], any>({
      path: `/employees`,
      method: "GET",
      secure: true,
      format: "json",
  ...
  employeesUpdate = (
    id: number,
    employee: GithubComPd120424DMountainServiceApiEmployeeInternalHandlerEmployeeUpdateRequest,
    params: RequestParams = {},
  ) =>
    this.request<
      GithubComPd120424DMountainServiceApiEmployeeInternalHandlerEmployeeResponse,
  ...
  employeesDelete = (id: number, params: RequestParams = {}) =>
    this.request<void, GithubComPd120424DMountainServiceApiEmployeeInternalHandlerErrorResponse>({
      path: `/employees/${id}`,
      method: "DELETE",
      secure: true,
      ...params,
  ...
  shiftWarningsList = (id: number, params: RequestParams = {}) =>
    this.request<Record<string, string[]>, GithubComPd120424DMountainServiceApiEmployeeInternalHandlerErrorResponse>({
  ...
  shiftsList = (id: number, params: RequestParams = {}) =>
    this.request<GithubComPd120424DMountainServiceApiEmployeeInternalHandlerShiftResponse[], any>({
  ...
  shiftsCreate = (
    id: number,
    shift: GithubComPd120424DMountainServiceApiEmployeeInternalHandlerAssignShiftRequest,
    params: RequestParams = {},
  ) =>
    this.request<
      GithubComPd120424DMountainServiceApiEmployeeInternalHandlerAssignShiftResponse,
  ...
  shiftsDelete = (
    id: number,
    shift: GithubComPd120424DMountainServiceApiEmployeeInternalHandlerRemoveShiftRequest,
    params: RequestParams = {},
  ) =>
    this.request<void, GithubComPd120424DMountainServiceApiEmployeeInternalHandlerErrorResponse>({
      path: `/employees/${id}/shifts`,
