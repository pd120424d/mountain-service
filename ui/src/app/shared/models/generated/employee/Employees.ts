...
employeesCreate: (employee: {
   ...
   */
    ...
    this.request<InternalHandlerEmployeeResponse, InternalHandlerErrorResponse>({
        path: `/employees`,
        method: 'POST',
                body: employee,        secure: true,        type: ContentType.FormData,        format: "json",        ...params,
    }),            /**
 ...
 * @secure
 */
profilePictureCreate: (id: number, employeeId: string, data: {
  /** Profile picture file */
    file: File,

}, params: RequestParams = {}) =>
    this.request<GithubComPd120424DMountainServiceApiEmployeeInternalHandlerUploadProfilePictureResponse, GithubComPd120424DMountainServiceApiEmployeeInternalHandlerErrorResponse>({
...
employeesUpdate: (id: number, employee: InternalHandlerEmployeeUpdateRequest, params: RequestParams = {}) =>
    this.request<InternalHandlerEmployeeResponse, InternalHandlerErrorResponse>({
        path: `/employees/${id}`,
        method: 'PUT',
                body: employee,        secure: true,        type: ContentType.Json,                ...params,
    }),            /**
 ...
 * @secure
 */
profilePictureDelete: (id: number, query: {
  /** Blob name to delete */
    blobName: string,

}, params: RequestParams = {}) =>
    this.request<GithubComPd120424DMountainServiceApiEmployeeInternalHandlerMessageResponse, GithubComPd120424DMountainServiceApiEmployeeInternalHandlerErrorResponse>({
...
shiftsCreate: (id: number, shift: InternalHandlerAssignShiftRequest, params: RequestParams = {}) =>
    this.request<InternalHandlerAssignShiftResponse, InternalHandlerErrorResponse>({
        path: `/employees/${id}/shifts`,
        method: 'POST',
                body: shift,        secure: true,        type: ContentType.Json,                ...params,
    }),            /**
